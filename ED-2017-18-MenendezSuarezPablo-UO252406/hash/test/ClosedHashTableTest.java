...
//	@Test
//	public void testAdd() {
//		// Lineal  (Hecho en clase por Nestor)
//		ClosedHashTable<Integer> tabla = new ClosedHashTable<>(7,0, 0.5, 0.16);
...
//		assertEquals(5, tabla.getNumOfElems());
//
//		assertTrue(tabla.add(36));
//		assertEquals(6, tabla.getNumOfElems());
//
//		assertTrue(tabla.add(43));
//		assertEquals(7, tabla.getNumOfElems());
//		
//
//		
//
...
//				
//		// Cuadratica  (Hecho en clase por Nestor)
...
//		//Teoría Lineal
//		
//		ClosedHashTable<Integer> tabla3 = new ClosedHashTable<>(5, 0.5, 0.16,(byte) 0);
//		
...
//		
//		ClosedHashTable<Integer> tabla4 = new ClosedHashTable<>(5, 0.5, 0.16,(byte) 1);
//		
...
//		
//		ClosedHashTable<Integer> tabla5 = new ClosedHashTable<>(5, 0.5, 0.16,(byte) 63);
//		
...
//		assertEquals(
//				"{_E_};{_E_};{24};{13};{4};{_E_};{_E_};{3};{_E_};{_E_};{_E_};[Size: 11 Num.Elems.: 4]",
//				tabla.toString());
////		System.out.println(tabla.toString());
//
...
//		assertEquals(7, tabla.getSize());
//
//		assertEquals("{_E_};{_E_};{2};{_E_};{_E_};{5};{_E_};[Size: 7 Num.Elems.: 2]",tabla.toString());
////		System.out.println(tabla.toString());
//	}
//	
//	/**
...
//
//		assertEquals(
//				"{_E_};{1};{_E_};{_E_};{_E_};{_E_};{_D_};{_E_};{_E_};{9};{_E_};[Size: 11 Num.Elems.: 2]",
//				tabla.toString());
//
